/**
 * Book Detail Page
 * Shows full book information, reviews, and recommendations
 */
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <button className="px-6 py-3 border-2 border-gray-300 text-gray-700 rounded-lg font-bold hover:bg-gray-50 smooth-transition flex items-center justify-center gap-2">
